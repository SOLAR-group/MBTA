public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("LARGEST_SUBARRAY_WITH_EQUAL_NUMBER_OF_0S_AND_1S," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("LARGEST_SUBARRAY_WITH_EQUAL_NUMBER_OF_0S_AND_1S," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("LARGEST_SUBARRAY_WITH_EQUAL_NUMBER_OF_0S_AND_1S," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
