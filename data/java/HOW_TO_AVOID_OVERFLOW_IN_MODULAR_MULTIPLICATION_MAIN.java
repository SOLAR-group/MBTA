public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("HOW_TO_AVOID_OVERFLOW_IN_MODULAR_MULTIPLICATION," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("HOW_TO_AVOID_OVERFLOW_IN_MODULAR_MULTIPLICATION," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
