public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("SEARCH_AN_ELEMENT_IN_AN_ARRAY_WHERE_DIFFERENCE_BETWEEN_ADJACENT_ELEMENTS_IS_1," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("SEARCH_AN_ELEMENT_IN_AN_ARRAY_WHERE_DIFFERENCE_BETWEEN_ADJACENT_ELEMENTS_IS_1," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("SEARCH_AN_ELEMENT_IN_AN_ARRAY_WHERE_DIFFERENCE_BETWEEN_ADJACENT_ELEMENTS_IS_1," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
