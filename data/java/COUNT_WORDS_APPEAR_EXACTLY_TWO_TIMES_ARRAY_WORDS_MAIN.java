public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("COUNT_WORDS_APPEAR_EXACTLY_TWO_TIMES_ARRAY_WORDS," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("COUNT_WORDS_APPEAR_EXACTLY_TWO_TIMES_ARRAY_WORDS," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("COUNT_WORDS_APPEAR_EXACTLY_TWO_TIMES_ARRAY_WORDS," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
