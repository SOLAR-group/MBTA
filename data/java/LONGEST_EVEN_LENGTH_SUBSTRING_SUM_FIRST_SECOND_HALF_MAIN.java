public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("LONGEST_EVEN_LENGTH_SUBSTRING_SUM_FIRST_SECOND_HALF," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("LONGEST_EVEN_LENGTH_SUBSTRING_SUM_FIRST_SECOND_HALF," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
