public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("LEXICOGRAPHICAL_CONCATENATION_SUBSTRINGS_STRING," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("LEXICOGRAPHICAL_CONCATENATION_SUBSTRINGS_STRING," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
