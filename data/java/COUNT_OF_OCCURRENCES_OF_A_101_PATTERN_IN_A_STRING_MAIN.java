public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("COUNT_OF_OCCURRENCES_OF_A_101_PATTERN_IN_A_STRING," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("COUNT_OF_OCCURRENCES_OF_A_101_PATTERN_IN_A_STRING," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
