public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("CHECK_CHARACTERS_GIVEN_STRING_CAN_REARRANGED_FORM_PALINDROME_1," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("CHECK_CHARACTERS_GIVEN_STRING_CAN_REARRANGED_FORM_PALINDROME_1," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
