public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("SUM_OF_ALL_SUBSTRINGS_OF_A_STRING_REPRESENTING_A_NUMBER," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("SUM_OF_ALL_SUBSTRINGS_OF_A_STRING_REPRESENTING_A_NUMBER," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
