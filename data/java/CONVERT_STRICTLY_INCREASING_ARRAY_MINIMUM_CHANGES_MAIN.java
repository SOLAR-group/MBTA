public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("CONVERT_STRICTLY_INCREASING_ARRAY_MINIMUM_CHANGES," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("CONVERT_STRICTLY_INCREASING_ARRAY_MINIMUM_CHANGES," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("CONVERT_STRICTLY_INCREASING_ARRAY_MINIMUM_CHANGES," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
