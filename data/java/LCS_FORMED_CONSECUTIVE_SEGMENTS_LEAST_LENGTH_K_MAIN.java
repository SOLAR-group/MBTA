public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("LCS_FORMED_CONSECUTIVE_SEGMENTS_LEAST_LENGTH_K_MAIN," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("LCS_FORMED_CONSECUTIVE_SEGMENTS_LEAST_LENGTH_K_MAIN," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("LCS_FORMED_CONSECUTIVE_SEGMENTS_LEAST_LENGTH_K_MAIN," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
