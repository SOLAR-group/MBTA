public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("CALCULATE_ANGLE_HOUR_HAND_MINUTE_HAND_MAIN," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("CALCULATE_ANGLE_HOUR_HAND_MINUTE_HAND_MAIN," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("CALCULATE_ANGLE_HOUR_HAND_MINUTE_HAND_MAIN," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
