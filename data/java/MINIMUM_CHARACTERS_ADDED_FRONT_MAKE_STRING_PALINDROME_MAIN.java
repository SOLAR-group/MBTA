public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("MINIMUM_CHARACTERS_ADDED_FRONT_MAKE_STRING_PALINDROME," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("MINIMUM_CHARACTERS_ADDED_FRONT_MAKE_STRING_PALINDROME," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
