public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("MAXIMUM_CONSECUTIVE_REPEATING_CHARACTER_STRING_1," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("MAXIMUM_CONSECUTIVE_REPEATING_CHARACTER_STRING_1," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
