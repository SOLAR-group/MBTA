public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("MAXIMUM_TRIPLET_SUM_ARRAY_2," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("MAXIMUM_TRIPLET_SUM_ARRAY_2," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
            builder.append("MAXIMUM_TRIPLET_SUM_ARRAY_2," + args[1] + "," + i + ",EXCEPTION\n");
        }
    }
