public static void main(String args[]) throws IOException {
    ...
    for(int i = 0; i < param0.size(); ++i)
    {
        try {
	        ...
	        {
                builder.append("CHECK_STRING_CAN_OBTAINED_ROTATING_ANOTHER_STRING_2_PLACES," + args[1] + "," + i + ",SUCCESS\n");
            } else {
                builder.append("CHECK_STRING_CAN_OBTAINED_ROTATING_ANOTHER_STRING_2_PLACES," + args[1] + "," + i + ",FAILURE\n");
            }
        } catch (Exception e) {
