    ...
    for i, parameters_set in enumerate(param):
        try:
            ...
            if parameters_set == filled_function_param[i]:
                print("MOVE_ZEROES_END_ARRAY," + sys.argv[1] + "," + str(i) + ",SUCCESS")
            else:
                print("MOVE_ZEROES_END_ARRAY," + sys.argv[1] + "," + str(i) + ",FAILURE")
        except:
            print("MOVE_ZEROES_END_ARRAY," + sys.argv[1] + "," + str(i) + ",EXCEPTION")
