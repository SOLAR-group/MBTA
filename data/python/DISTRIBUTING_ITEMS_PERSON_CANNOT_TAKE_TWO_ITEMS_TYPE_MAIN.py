    ...
    for i, parameters_set in enumerate(param):
        try:
            if f_filled(*parameters_set) == f_gold(*parameters_set):
                print("DISTRIBUTING_ITEMS_PERSON_CANNOT_TAKE_TWO_ITEMS_TYPE," + sys.argv[1] + "," + str(i) + ",SUCCESS")
            else:
                print("DISTRIBUTING_ITEMS_PERSON_CANNOT_TAKE_TWO_ITEMS_TYPE," + sys.argv[1] + "," + str(i) + ",FAILURE")
        except:
