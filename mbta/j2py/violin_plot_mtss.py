...
if __name__ == "__main__":
    ...
    violin.set(ylabel="Mutant-based Translation Score")
    plt.savefig('plots/violin_mts_j2py.png')
    ...
    violin.set(ylabel="Computational Accuracy")
    plt.savefig('plots/violin_computational_accuracy_j2py.png')
